...
//				sts.remove(sts.size() - 1);
	...
	public static void main(String[] args) {
		...
		s1.toCharArray();
		WordLadder2 ws = new WordLadder2();

		ArrayList<ArrayList<String>> v = ws.findLadders(s1, s2, dict);

		// for(ArrayList<String> as:v){
		// for(String ts:as)
		// System.out.print(ts+" , ");
		// System.out.println();
		// }
